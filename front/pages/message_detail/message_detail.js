...
Page({
  ...
  admin() {
    ...
    wx.showModal({
      title: '信息',
      content: "手机号:" + that.data.messageDetail.userPhone + ",用户Id:" + that.data.messageDetail.userId + ",用户名:" + that.data.messageDetail.user.userNickname + ",文章id:" + that.data.messageDetail.messageId,
      cancelText: "复制号码",
      confirmText: "系统回复",
      success: function(e) {
        if (e.confirm) {
